...
object MapLayerIds {
    ...
    const val TRAFFIC_AWARENESS_ATTENTION_GLYPH_LAYER_ID = "traffic-awareness-attention-glyph-layer"
    ...
    const val AIR_AWARENESS_ALERT_RINGS_SOURCE_ID = "air-awareness-alert-rings-source"
    const val AIR_AWARENESS_ALERT_RINGS_FILL_LAYER_ID = "air-awareness-alert-rings-fill-layer"
    const val AIR_AWARENESS_ALERT_RINGS_LINE_LAYER_ID = "air-awareness-alert-rings-line-layer"
    ...
    const val WEATHER_WIND_SOURCE_ID = "dsc-weather-map-source"
    const val WEATHER_WIND_HALO_LAYER_ID = "dsc-weather-wind-halo"
    const val WEATHER_WIND_ARROW_LAYER_ID = "dsc-weather-wind-arrow"
