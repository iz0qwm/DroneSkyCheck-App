...
object AuthorizationDraftValidator {
    fun validate(
        ...
        val missing = buildList {
            ...
            requireField(requestData.operationStartDate.ifBlank { requestData.operationStartDateTime.take(10) }, "operation.startDate", "Operazione", "Inizio operazioni")
            requireField(requestData.operationEndDate.ifBlank { requestData.operationEndDateTime.take(10) }, "operation.endDate", "Operazione", "Fine operazioni")
